...
│   └── fonts/         # magical\_font.ttf, ui\_font.ttf

├── external/          # SDL3, SDL3\_image, SDL3\_ttf, SDL3\_mixer
...
├── SDL3\_image/  include/ + lib/x64/SDL3\_image.lib + SDL3\_image.dll

├── SDL3\_ttf/    include/ + lib/x64/SDL3\_ttf.lib + SDL3\_ttf.dll

└── SDL3\_mixer/  include/ + lib/x64/SDL3\_mixer.lib + SDL3\_mixer.dll
...
| SDL3\_image | https://github.com/libsdl-org/SDL\_image/releases |

| SDL3\_ttf | https://github.com/libsdl-org/SDL\_ttf/releases |

| SDL3\_mixer | https://github.com/libsdl-org/SDL\_mixer/releases |
...
git clone https://github.com/YOUR\_USERNAME/enchanted-climber.git
